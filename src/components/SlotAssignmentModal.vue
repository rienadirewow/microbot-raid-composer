...
const ShieldIcon = () => h('svg', { class: 'h-4 w-4', fill: 'currentColor', viewBox: '0 0 20 20' }, [
  h('path', { 
    'fill-rule': 'evenodd', 
...
const HeartIcon = () => h('svg', { class: 'h-4 w-4', fill: 'currentColor', viewBox: '0 0 20 20' }, [
  h('path', { 
    'fill-rule': 'evenodd', 
...
const SwordIcon = () => h('svg', { class: 'h-4 w-4', fill: 'currentColor', viewBox: '0 0 20 20' }, [
  h('path', { 
    'fill-rule': 'evenodd', 
